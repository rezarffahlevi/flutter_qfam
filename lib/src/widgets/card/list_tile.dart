...
class MyListTile extends StatelessWidget {
  ...
  /// The MyListTile's background color. Can be given [Color] or [GFColors]
  final Color? color;

  /// type of [Widget] or [GFAvatar] used to create rounded user profile
  final Widget? avatar;

  /// The title to display inside the [MyListTile]. see [Text]
  final Widget? title;

  /// The subTitle to display inside the [MyListTile]. see [Text]
  final Widget? subTitle;

  /// The description to display inside the [MyListTile]. see [Text]
  final Widget? description;

  /// The icon to display inside the [MyListTile]. see [Icon]
  final Widget? icon;

  /// defines the margin of MyListTile
  final EdgeInsets margin;

  /// defines the padding of MyListTile
